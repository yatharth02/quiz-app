...
import { combineMaps, getTeamName } from "./Helper";
          ...
          <table className="result_team-container">
            <tr>
              <td className="result_team result_winner">
                <p style={{ color: "White" }}>
                  Team:{getTeamName(finaTotalScoreMap[0][0].split("-")[1])}
                </p>
              ...
              <td className="result_team">
                <p>2nd Place</p>
                <p>Team:{getTeamName(finaTotalScoreMap[1][0].split("-")[1])}</p>
                <p>Score: {finaTotalScoreMap[1][1]}</p>
                <p>Result: Runner-Up</p>
              </td>
              <td className="result_team">
                <p>3rd Place</p>
                <p>Team:{getTeamName(finaTotalScoreMap[2][0].split("-")[1])}</p>
            ...
            <tr>
              <td className="result_team">
                <p>4th Place</p>
                <p>Team:{getTeamName(finaTotalScoreMap[3][0].split("-")[1])}</p>
                <p>Score: {finaTotalScoreMap[3][1]}</p>
                <p>Result: Participant</p>
              </td>
              <td className="result_team">
                <p>5th Place</p>
                <p>Team:{getTeamName(finaTotalScoreMap[4][0].split("-")[1])}</p>
                <p>Score: {finaTotalScoreMap[4][1]}</p>
                <p>Result: Participant</p>
              </td>
              <td className="result_team">
                <p>6th Place</p>
                <p>Team:{getTeamName(finaTotalScoreMap[5][0].split("-")[1])}</p>
